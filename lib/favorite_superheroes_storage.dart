...
class FavoriteSuperheroesStorage {
  ...
  factory FavoriteSuperheroesStorage.getIntsance() =>
  ...
  Future<bool> addToFavorites(final Superhero superhero) async {
    ...
    rawSuperheroes.add(jsonEncode(superhero.toJson()));
